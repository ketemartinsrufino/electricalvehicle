globals
[
  demanda    ; lista com os percentuais de carros em casa
  hora       ; hora do dia
]
...
to setup
  ...
  set hora 0
  set demanda [10 5 5 5 10 20 40 50 70 70 60 55 40 30 60 70 85 90 80 60 50 40 30 20]
  ...
  create-carros número-de-carros
  [
    let xd 0
    let yd 0
    setxy round random-xcor round random-ycor
...
to go
  ...
  ifelse numCarCasa / count carros * 100 >= item hora demanda
  [
...
"" ""
PENS
"default" 1.0 0 -13840069 true "" "plot count carros with [color = green]"
