...
to setup
  ...
  set demanda-carros-fora [ 3 3 2 2 3 5 30 40 50 60 70 85 75 60 80 93 95 96 99 70 40 20 3 3]
  ...
  [
    ...
    [
     ...
     [
       set carga-atual round carga-atual + inc-transformador
       set label  carga-atual
...
to go
  ...
  [
    ...
    [
      let soma-da-carga carga-armazenada + carregador
      let muda-valor-transformador false
      let incremento-transformador carregador
      ...
      [
        ...
        set color green
        set estado "carregado"
        set incremento-transformador (-1 * carregador)
        set muda-valor-transformador true
      ]
      [
